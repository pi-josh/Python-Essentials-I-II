...
Let's try something new now. A queue is a data model characterized by the term FIFO: First In - First Out.
Note: a regular queue (line) you know from shops or post offices works exactly in the same way 

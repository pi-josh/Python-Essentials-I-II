...
John had three apples, Mary had five apples,
and Adam had six apples.
...
3. having stored the numbers in the variables,
   print the variables on one line,
...
experiment with your code: create new variables,

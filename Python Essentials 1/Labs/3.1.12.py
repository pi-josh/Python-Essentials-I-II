...
'''
Scenario
As you surely know, due to some astronomical reasons,
years may be leap or common. The former are 366 days long,
...
Look at the code in the editor - it only reads a year number,
